...
<a href="sectionB.jsp"><h1>Book Another Ticket</h1></a>
</div>
...
<% 
 ...
 String name = request.getParameter("name");
        ...
        try{
            ...
            String s = "insert into sectionB(name, email, zip, state, seatNum,bookTime) values(?,?,?,?,?,?)";
			...
			ps.setString(1, "name"); */
			ResultSet rs = st.executeQuery("select name,seatNum from sectionB  order by bookTime DESC limit 1");
			while(rs.next()){
            ...
            out.println("<script> window.location='sectionB.jsp' </script>");
