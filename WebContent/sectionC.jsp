    ...
    <div class="box-1 bg-light user">
        ...
        <div class="box-inner-1 pb-3 mb-3 ">
            <div class="d-flex justify-content-between mb-3 userdetails">
                <p class="fw-bold">Section C Checkout</p>
                <p class="fw-lighter"><span class="fas fa-dollar-sign"></span>Seats: 101-144</p>
            </div>
            <div id="my" class="carousel slide carousel-fade img-details" data-bs-ride="carousel" data-bs-interval="2000">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item"> <img src="section_c.png" class="d-block w-100 h-100"> </div>
            ...
            <div class="radiobtn"> <input type="radio" name="box" id="one" > <input type="radio" name="box" id="two"> <input type="radio" name="box" id="three"> <label for="one" class="box py-2 first">
                    <div class="d-flex align-items-start"> <span class="circle"></span>
                        <div class="course">
                       <a href="sectionA.jsp">  <div class="d-flex align-items-center justify-content-between mb-2"> <span class="fw-bold"> Section A </span> <span class="fas fa-dollar-sign">₹</span> </div> <span>5000</span></a> 
                        </div>
                    </div>
                    ...
                    <div class="address">
                        ...
                        <div class="d-flex flex-column dis">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <p>Subtotal</p>
                                <p><span class="fas fa-dollar-sign"></span>10,000.00</p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <p>GST<span>(18%)</span></p>
                                <p><span class="fas fa-dollar-sign"></span>1,800</p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <p class="fw-bold">Total</p>
                                <p class="fw-bold"><span class="fas fa-dollar-sign"></span>11,800.00</p>
                            </div>
