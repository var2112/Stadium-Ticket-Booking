...
<body style=" background: #fdf298;
    ...
    <div class="box-1 bg-light user">
        ...
        <div class="box-inner-1 pb-3 mb-3 ">
            <div class="d-flex justify-content-between mb-3 userdetails">
                <p class="fw-bold">Section A Checkout</p>
                <p class="fw-lighter"><span class="fas fa-dollar-sign"></span>Seats: 501-552</p>
            </div>
            <div id="my" class="carousel slide carousel-fade img-details" data-bs-ride="carousel" data-bs-interval="2000">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item"> <img src="section_a.png" class="d-block w-100 h-100"> </div>
    ...
    <div class="box-2">
        <div class="box-inner-2">
            ...
            <form action="secA.jsp" method="post">
                    ...
                    <div class="address">
                        ...
                        <div class="d-flex flex-column dis">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <p><span class="fas fa-dollar-sign"></span>18.09</p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <p class="fw-bold">Total</p>
                                <p class="fw-bold"><span class="fas fa-dollar-sign"></span>5900.00</p>
                            </div>
